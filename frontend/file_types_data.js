...
const defaultFileTypes = [
    ...
    { id: 't_other', name: 'Otros', color: '#95a5a6', identifier: 'otros', aliases: ['other'], searchIn: 'all', amp: 0, report: false, history: true, voice: false, readonly: true, showShortcut: true, ...defaultFadeProfile }
];
